...
public class PdfTextListener implements TextProvidingRenderListener {
    ...
    public void renderText(TextRenderInfo renderInfo) {
        ...
        if (!firstRender){
            ...
            if (dist > sameLineThreshold)
                hardReturn = true;
            */
            if (x2.get(Vector.I2) != x0.get(Vector.I2))
                hardReturn = true;
        ...
        if (hardReturn){
            ...
            /*
                ...
                if (spacing > renderInfo.getSingleSpaceWidth()/2) {
                    result.append(' ');
                }
            */
            }
